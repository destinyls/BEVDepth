...
class DetMVNuscEvaluator():
    ...
    def evaluate(
        ...
        kitti_evaluation(pred_label_path, gt_label_path, metric_path="output/bev_height_lss_r50_256x704_128x128_24e")
...
if __name__ == "__main__":
    result_files = "./outputs/bev_height_lss_r50_256x704_128x128_24e/results_nusc.json"
    dair_root = "data/dair-v2x"
    gt_label_path = os.path.join("data/dair-v2x-kitti", "training", "label_2")
    results_path = "outputs"
