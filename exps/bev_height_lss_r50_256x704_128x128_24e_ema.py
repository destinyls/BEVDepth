...
from exps.bev_height_lss_r50_256x704_128x128_24e import \
...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./outputs/bev_height_lss_r50_256x704_128x128_24e_ema/checkpoints', filename='{epoch}', every_n_epochs=10, save_last=True, save_top_k=-1)
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='./outputs/bev_height_lss_r50_256x704_128x128_24e_ema')
