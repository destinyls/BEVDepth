...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./outputs/bev_depth_lss_r50_256x704_128x128_24e_ema/checkpoints', filename='{epoch}', every_n_epochs=4, save_last=True, save_top_k=-1)
